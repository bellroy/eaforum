...
string_dict = dict(
    ...
    friends = _('To view the EA Forum with only submissions from your friends, use [effective-altruism.com/r/friends](%s)'),
    ...
    email_not_validated = _('In order to post and comment you will need to [verify your email address](/verifyemail).')
)
